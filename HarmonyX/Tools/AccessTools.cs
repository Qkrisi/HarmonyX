...
namespace HarmonyXLib
{
	...
	public static class AccessTools
	{
		...
		/// <summary>Creates a delegate for a given delegate definition, attributed with [<see cref="HarmonyDelegate"/>]</summary>
		/// <typeparam name="DelegateType">The delegate Type, attributed with [<see cref="HarmonyDelegate"/>]</typeparam>
		/// <param name="instance">
		/// Only applies for instance methods. If <c>null</c> (default), returned delegate is an open (a.k.a. unbound) instance delegate
		/// where an instance is supplied as the first argument to the delegate invocation; else, delegate is a closed (a.k.a. bound)
		/// instance delegate where the delegate invocation always applies to the given <paramref name="instance"/>.
		/// </param>
		/// <returns>A delegate of given <typeparamref name="DelegateType"/> to the method specified via [<see cref="HarmonyDelegate"/>]
		...
		/// determined from the [<see cref="HarmonyDelegate"/>] attributes on <typeparamref name="DelegateType"/>,
