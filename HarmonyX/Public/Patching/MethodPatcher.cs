...
namespace HarmonyXLib.Public.Patching
{
	/// <summary>
	...
	public abstract class MethodPatcher
	{
		...
		/// If <b>null</b>, Harmony patches must be manually applied to the original via <see cref="HarmonyManipulator.Manipulate(System.Reflection.MethodBase,PatchInfo,MonoMod.Cil.ILContext)"/>.
		/// </returns>
		///
		...
		/// Result of <see cref="HarmonyManipulator.Manipulate(System.Reflection.MethodBase,PatchInfo,MonoMod.Cil.ILContext)"/>
		...
		/// with <see cref="HarmonyManipulator.Manipulate(System.Reflection.MethodBase,PatchInfo,MonoMod.Cil.ILContext)"/>.
		/// </param>
